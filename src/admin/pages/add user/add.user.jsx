    ...
    <React.Fragment>
      {loading ? (
        ...
        <div >
               ...
               <Sidebar />
          <form style={{ "padding-left": "350px", "padding-top": "50px","backgroundColor":"" }} onSubmit={handleSubmit}>
            <h3 style={{ "padding-left": "50px", "padding-top": "20px", "color": "#28a745","backgroundColor":"","width":"450px","font-size":"40px"}}>Add New Admin</h3>

            <div className="form-group row py-2" >

              <label for="firstname" className="col-sm-2 col-form-label text-dark">First Name</label>
            ...
            <div className="form-group row py-2" >
              ...
              <label for="lastname" className="col-sm-2 col-form-label text-dark">Last Name</label>
              <div className="col-sm-6">
            ...
            <div className="form-group row py-2" >
              ...
              <label for="staticEmail" className="col-sm-2 col-form-label text-dark">Email</label>
              <div className="col-sm-6">
            ...
            <div className="form-group row">
              <label for="inputPassword" className="col-sm-2 col-form-label text-dark">Password</label>
              <div className="col-sm-6">
            ...
            <div >
              <button className="btn btn-success px-5 ml-10" style={{"width":"450px"}} type="submit">Save</button>
            </div>
