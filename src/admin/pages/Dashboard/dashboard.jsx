  ...
  return (
    <div>
      ...
      <section className="home-section">
        ...
        {/* <p className="admin_name">{savedUser[0]}</p> */}
            ...
            <div className="top-sales box">
              ...
              <div className="card mb-2" >
                <div className="card-body">
                  <div className='row'>
                    <div className='col-4'>
                      <img className='col-8' src="./images/cinnamon.jpg" />
                    </div>
                    <div className='col-4'>
                      <p className="card-title">Cinnamon Sticks</p>
                    </div>
                    <div className='col-4'>
                      <p className="card-title">Rs.5945.34</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="card mb-2" >
                <div className="card-body">
                  <div className='row'>
                    <div className='col-4'>
                      <img className='col-8' src="./images/organic.jpg" />
                    </div>
                    <div className='col-4'>
                      <p className="card-title">Cinnamon Bark Oil</p>
                    </div>
                    <div className='col-4'>
                      <p className="card-title">Rs.5545.34</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="card" >
                <div className="card-body">
                  <div className='row'>
                    <div className='col-4'>
                      <img className='col-8' src="./images/pepper.jpg" />
                    </div>
                    <div className='col-4'>
                      <p className="card-title">Black Pepper</p>
                    </div>
                    <div className='col-4'>
                      <p className="card-title">Rs.5345.34</p>
                    </div>
                  </div>
                </div>
              </div>
