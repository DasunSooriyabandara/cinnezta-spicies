...
console.log(docSnap);
			...
			docSnap.forEach(async (doc) => {
				...
				if(data !== undefined && data !== null) {
					...
					//console.log(fireAction_signIn.user.email);
	...
	return (
		<div className='p-500 m-100 text-center bg-warning' >
			
			<div className='row center '>
				<div className='col-3' >
					<img style={{"padding": "100px -300px 50px 300px", "width": "612px", "height": "408px" }} 
					 src="./images/adminlogin.jpg"/>
					 
					<img style={{ "padding": "300px -50px 300px 100px", "width": "612px", "height": "408px" }} 
					 src="./images/adminlogin1.jpg"/>
				</div>

				{/* <div className='col-3' >
					<img style={{ "padding": "2000px -150px 1000px ", "width": "612px", "height": "408px" }} 
					 src="./images/adminlogin1.jpg"/>
				</div> */}
				<div style={{ "padding": "100px 50px " }} className='col-6 py-500'>
					<div className=" card row  my-50 bg-dark">
						<div >
							<div className="img-left d-none d-md-flex">
							</div>
							
							<div className="card-body col-12 p-10  ">
								<h4 className="title text-center mt-4 text-light">
									Admin Login
								</h4>
								<form className="form-box px-3 width-50px" onSubmit={handleSubmit}>
