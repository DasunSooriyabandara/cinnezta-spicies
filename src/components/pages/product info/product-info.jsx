          ...
          {validSearch ? (
            <div className='row'>
              <div className='col-6'>
                ...
                <div className='col-6 '>
                  <h3 style={{"padding":"40px","color":"140E0A","text-transform":"uppercase"}}>{data_title}</h3>
                    <hr/>
                  <h3 style={{"padding-left":"50px"}}>Product Description</h3>
                  <p style={{"padding":"50px"}}>{data_description}</p>
                  <p style={{"padding-left":"50px"}}>Pack
                  ...
                  <button style={{"padding":"10px","width":"250px","margin":"30px","boder-color":"black"}} className='btn btn-warning' onClick={handleAddToCart}>Add to cart</button>
                  <hr/>
                  <div></div>
                </div>
            <div className="row">
