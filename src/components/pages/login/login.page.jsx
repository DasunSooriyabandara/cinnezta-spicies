                ...
                <div className="login-page">
                    <div className="container">
                        <div className="row px-3 mb-5 pt-5">
                            <div className="col-lg-10 col-xl-9 card rounded-3    flex-row mx-auto px-0 text-center">
                                ...
                                <div className="card-body">
                                    ...
                                    <form className="form-box px-3 content-center" >
                                        {
                                            validate && <div>
                                        ...
                                        <div className="form-input">
                                            <input type="email" placeholder="Input your Email" name="email" tabIndex="20"
                                                onChange={emailcheck} />
                                        </div>
                                        <div className="form-input">
