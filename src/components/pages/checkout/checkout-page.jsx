          ...
          <React.Fragment>
            {user ? (
                <div style={{"min-height":"600px","padding":"15px"}}>
                    ...
                    <div className="row">
                    <h1 className="ms-0" style={{"color":"black","text-align":"left","padding-top":"10px","font-size":"50px"}}>BILLING & SHIPPING</h1>
                        ...
                        <div >
                            <hr/>
                            <div>
                                <h3 style={{"color":"black","text-align":"left","padding-top":"10px","font-size":"30px","padding-left":"20px"}}>Order Summary</h3>
                                 <br/>       
                            </div>
                            <div className="row">
                                <div className="col-6">
