...
const ProductPageStones = () => {
    ...
    useEffect(() => {
        ...
        async function fetchData() {
            ...
            var results = [];
            const querySnapshot = await getDocs(query(collection(db, "products"), where("category", "==", "organic_products")));
               ...
               <div className="col-md-3">
                    <div className="card m-3 bg-secondary">
                        ...
                        <div className="card-body mt-0">
                            ...
                            <button onClick={filterHandler} className="btn btn-dark btn-sm mt-3 float-end">Filter
                            </button>
                        </div>
                    </div>
               </div>
               <div className="col-md-9 mt-2">
                   <h3 className="ms-2">ORGANIC PRODUCTS</h3>
