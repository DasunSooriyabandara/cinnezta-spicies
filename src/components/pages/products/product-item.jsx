...
const ProductItem = (props) => {
    ...
    return(
        <div className="card rounded-3 m-2" onClick={viewProduct}>
            ...
            <div>
                <p style={{color:'#6E260E',"padding-left":"50px"}}>{props.stock} items available</p>
                <button style={{ cursor: 'pointer', padding: '5px 10px', margin: '5px', border: 'solid thin gray', borderRadius: '5px'  ,"width":"225px","color":"black","background-color":"#FFC30B"}} onClick={addToCart}>Add to Cart</button> 
            </div>
