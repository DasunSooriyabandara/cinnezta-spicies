    ...
    return (
        <>
                ...
                <div className="d-flex justify-content-center flex-row">
                    ...
                    <div onClick={() => {
                        ...
                        <img className="rounded-circle"
                             ...
                             width="100" height="100" alt=""/>
                        <p className="text-center text-uppercase fw-bold">Cinnamon</p>
                    </div>
                    <div onClick={() => {
                        ...
                        <img className="rounded-circle"
                             ...
                             width="100" height="100" alt=""/>
                        <p className="text-center text-uppercase fw-bold">Organic</p>
                    </div>
                    <div onClick={() => {
                        ...
                        <img className="rounded-circle"
                             ...
                             width="100" height="100" alt=""/>
                        <p className="text-center text-uppercase fw-bold">Pepper</p>
                    </div>
                    {/* <div onClick={() => {
            ...
            <div className="row position-relative">
                <img className="hero-img" height="500px" width="10%"
                     src="./images/spicies.jpg" alt=""/>           
                     {/* "https://image.freepik.com/free-photo/3d-green-palm-leaves-arrangement_23-2149015445.jpg" */}
                <div className="position-absolute mt-5 w-100 d-flex flex-column animate__animated animate__slideInUp">
                    <h1 className="fw-bolder p-0 m-0 w-100 text-light text-center fs-100">Freshness </h1>  
                    <h6 className="fw-bolder p-0 m-0 w-100 text-light text-center fs-100"> Of</h6> 
                    {/* Grow Bit By Bit */}
                    <div className="d-flex w-100 flex-row">
                        <h1 className="fw-bolder text-light p-0 m-0 w-100 text-center fs-100">Ceylon Spices</h1>
                    </div>
