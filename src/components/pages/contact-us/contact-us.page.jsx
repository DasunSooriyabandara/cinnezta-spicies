    ...
    return (
        <>
            <div className="row position-relative g-0">
                <img className="hero-img" height="600px" width="100%" src="./images/contact.jpg" alt="" />
            ...
            <div className="my-5 g-0 container">
                <h1 className="fw-bolder text-center text-dark p-0 m-0 animate__animated animate__slideInUp">
                    Contact us </h1>
            ...
            <div className="row g-0 animate__animated animate__slideInUp my-5">
                <div className="col text-center">
                    <h1 className="fs-50 fw-bolder text-dark">Email</h1>
                    <p>cinneztapvtltd@gmail.com</p>
                </div>
                <div className="col text-center border-start border-end">
                    <h1 className="fs-50 fw-bolder text-dark">Contact no</h1>
                    <p> 0778910663 | 0912235190</p> 
                </div>
                <div className="col text-center">
                    <h1 className="fs-50 fw-bolder text-dark">Facebook Link </h1>
                    <a href>https://www.facebook.com/cinnezta-108468884448211</a>
                </div>
            </div>
